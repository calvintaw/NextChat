...
export const ServerImageUploadBtn = ({ uploaded, setUploaded, setSelectedFile, publicImgUrl }: ServerImageUploadBtnProps) => {
	...
	return (
		<>
			<label htmlFor="server-img-upload-input" className="w-fit h-fit mx-auto">
				<div
					className={clsx(
						"size-22 group rounded-full items-center justify-center cursor-pointer relative flex flex-col",
