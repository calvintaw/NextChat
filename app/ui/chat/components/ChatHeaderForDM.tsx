...
export function DirectMessageCard({ roomId, currentUserId, user }: { roomId: string, currentUserId: string; user: User }) {
  ...
  return (
    <div className="bg-contrast text-white p-6 pb-2 rounded-lg max-w-full">
