...
const NewsBlock: React.FC<NewsBlockProps> = ({ title, source, timestamp, url, imageUrl, content}) => {
  ...
  return (
		<a
			...
			className="newsblock block border-3 hover:border-tertiary border-secondary rounded-2xl overflow-hidden hover:shadow-lg no-underline decoration-0 mb-3 group"
		>
			{imageUrl && (
