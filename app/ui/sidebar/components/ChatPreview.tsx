...
import { ChatPanelHeaderButtons, getDMRoom } from "@/app/lib/utilities";
import { CreateDMButton } from "../../chat/components/ChatHeader/components/CreateDMDialog";
	...
	return (
		<>
			<div className="flex flex-col gap-0.75">
				{ChatPanelHeaderButtons.map(({ id, icon, label, href }) => {
					const Icon = icon;
					return (
						<Link
							key={id}
