...
export const TermsAndServices = () => {
	return (
		<div className="flex items-center gap-2 text-muted mt-1 ml-0.5 text-sm">
			<input type="checkbox" defaultChecked className="form-checkbox size-4.5 rounded-sm transform" />I agree to the{" "}
			<Link href={"/terms_and_services"}>Terms and Conditions</Link>
		</div>
	);
};
